...
<style scoped>
  ...
  .popup__msg>.popup__msg-hint>.iconfont{
    display: inline-block;width: 8%;height :25%;font-size: .80rem;background: url("../../../static/images/iconfont.png") no-repeat center;-webkit-background-size: 90% auto;background-size: 90% auto;margin-right: 3%;
  }
